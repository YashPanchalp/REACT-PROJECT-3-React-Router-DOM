export default function Features() {
    return(
        ...
        <div class="p-6 pt-18 pb-30">
      <div class="max-w-7xl max-md:max-w-lg mx-auto">
        <div class="text-left">
          <h2 class="text-3xl font-bold text-slate-900 inline-block decoration-underline pb-15">LATEST BLOGS</h2>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16 mt-12">
