...
export default function Header() {
  return (
    <header class="w-[1540px] flex shadow-lg py-4 px-4 sm:px-10 bg-white min-h-[50px] tracking-wide relative z-50 -ml-40 pb-10 -mt-4">
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li class="mb-6 hidden max-lg:block">
              <a href="javascript:void(0)"><img src="./assets/download.jpg" alt="logo" class="w-36" />
              </a>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
              <NavLink to={'/home'}
                class="hover:text-blue-700 text-blue-700 block font-medium text-[15px]">Home</NavLink>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><NavLink to={'/team'}
              class="hover:text-blue-700 text-slate-900 block font-medium text-[15px]">Team</NavLink>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><NavLink to={'/features'}   
              class="hover:text-blue-700 text-slate-900 block font-medium text-[15px]">Feature</NavLink>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><NavLink to={'/blog'} href='javascript:void(0)'
              class="hover:text-blue-700 text-slate-900 block font-medium text-[15px]">Blog</NavLink>
            </li>
          </ul>
        </div>
